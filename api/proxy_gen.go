...
func (s *StorageMinerStruct) SchedAlreadyIssueInfo(ctx context.Context) (int64, error) {
	//TODO implement me
	panic("implement me")
}

func (s *StorageMinerStruct) SchedSetAlreadyIssue(ctx context.Context, num int64) error {
	//TODO implement me
	panic("implement me")
}

func (s *StorageMinerStruct) SchedAddAlreadyIssue(ctx context.Context, num int64) error {
	//TODO implement me
	panic("implement me")
}

func (s *StorageMinerStruct) SchedSubAlreadyIssue(ctx context.Context, num int64) error {
	//TODO implement me
	panic("implement me")
}

func (s *StorageMinerStruct) WorkerSetTaskCount(ctx context.Context, tc record.TaskCount) error {
	//TODO implement me
	panic("implement me")
}

func (s *StorageMinerStruct) WorkerAddP1(ctx context.Context, Number abi.SectorNumber, uid uuid.UUID) error {
	//TODO implement me
	panic("implement me")
}

func (s *StorageMinerStruct) WorkerAddAp(ctx context.Context, Number abi.SectorNumber, uid uuid.UUID) error {
	//TODO implement me
	panic("implement me")
}

func (s *StorageMinerStruct) WorkerGetTaskCount(ctx context.Context, id string) (record.TaskCount, error) {
	//TODO implement me
	panic("implement me")
}

func (s *StorageMinerStruct) WorkerDelTaskCount(ctx context.Context, id string) error {
	//TODO implement me
	panic("implement me")
}

func (s *StorageMinerStruct) WorkerDelAll(ctx context.Context) error {
	//TODO implement me
	panic("implement me")
}

func (s *StorageMinerStruct) WorkerGetTaskList(ctx context.Context) ([]record.TaskCount, error) {
	//TODO implement me
	panic("implement me")
}

func (s *StorageMinerStruct) StorageSetWeight(ctx context.Context, storageID storiface.ID) error {
	//TODO implement me
	panic("implement me")
}

func (s *StorageMinerStruct) StorageLockByID(ctx context.Context, storageID storiface.ID, uid uuid.UUID) (int, error) {
	//TODO implement me
	panic("implement me")
}

func (s *StorageMinerStruct) StorageUnLockByID(ctx context.Context, storageID storiface.ID, uid uuid.UUID) error {
	//TODO implement me
	panic("implement me")
}

func (s *StorageMinerStruct) PledgeSector(ctx context.Context, u uint64) (abi.SectorID, error) {
	//TODO implement me
	panic("implement me")
}
